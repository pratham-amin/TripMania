...
export const Navbar = () => {
  ...
  return (
    <>
      <nav>
        <div className="logo">
          <Link to="/"><span>T</span>ripMania</Link>
        ...
        <ul className="list">
          ...
          <li id="drop">
            ...
            <ul>
              ...
              <li><Link to="/locations/uttarakhand" id="d">Uttarakhand</Link></li>
              <li><Link to="/locations/karnataka" id="d">Karnataka</Link></li>
              <li><Link to="/locations/chennai" id="d">Chennai</Link></li>
              <li><Link to="/locations/delhi" id="d">Delhi</Link></li>
              <li><Link to="/locations/rajasthan" id="d">Rajasthan</Link></li>
